...
-- Nhóm Phụ thuộc cấp 1:

-- QuanLy và NhanVien (Tham chiếu TaiKhoan)

-- NhaGa (Tham chiếu QuanLy)

-- ToaTau (Tham chiếu DoanTau)

-- Nhóm Phụ thuộc cấp 2 (Chi tiết & Lịch trình):

-- GheNgoi (Tham chiếu ToaTau)

-- ChiTietHanhTrinh (Tham chiếu NhaGa, HanhTrinh)

-- LichTrinh (Tham chiếu DoanTau, HanhTrinh, QuanLy)

-- ChiTietLichTrinh (Tham chiếu NhaGa, LichTrinh)

-- Nhóm Giao dịch & Báo cáo:

-- HoaDon (Tham chiếu NhanVien, KhachHang)

-- VeTau (Tham chiếu LichTrinh, NhanVien, KhachHang, GheNgoi, ChinhSachGia, HoaDon)

-- PhieuTraVe (Tham chiếu VeTau, NhanVien, HoaDon)

-- BaoCao (Tham chiếu QuanLy)
